...
export default function AddOrderItemForm({ orderId, products, addAction }: Props) {
    ...
    <Card>
      ...
      <CardContent>
        ...
        <form action={handleSubmit} className="grid grid-cols-1 md:grid-cols-4 gap-3">
          ...
          <div>
            <Label htmlFor="orderedQty">Quantity</Label>
            <Input id="orderedQty" name="orderedQty" type="number" min="1" required />
          </div>
          <div>
